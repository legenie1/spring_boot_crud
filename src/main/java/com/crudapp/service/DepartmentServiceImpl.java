...
public class DepartmentServiceImpl implements DepartmentService {
    ...
    public Department updateDepartment(Long departmentId, Department department) {
        ...
        if (Objects.nonNull(department.getDepartmentAdresse()) && !"".equalsIgnoreCase(department.getDepartmentAdresse())){
            depDB.setDepartmentAdresse(department.getDepartmentAdresse());
        }
